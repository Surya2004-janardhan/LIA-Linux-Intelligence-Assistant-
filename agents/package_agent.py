...
class PackageAgent(LIAAgent):
    def __init__(self):
        ...
        self.register_tool("install_system", self.install_system, "Installs a system package (apt/pacman/dnf)",
            keywords=["install package", "apt install", "pacman install", "dnf install"])
